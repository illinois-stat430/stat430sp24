...
For the entire 2017-2022 (2020 excluded) statcast data set: https://uofi.app.box.com/file/1449126291821?s=we34tcz4wqdu063zpzuwjvb4r6u9j21s
...
The more elaborate model offers relatively poor out-of-sample prediction for 2021 player HR totals.

\vspace{12pt}

\small
```{r}
bat_aug_m2 = bat_not_2021 %>% 
