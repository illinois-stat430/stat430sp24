...
We will let $\x_p$ and $\x_b$ be pitching and batting characteristics, and let $\x = (\x_p',\x_b')'$. 
...
$$
$d_p$ is the dimension of $\x_{p,j_1,t}$ and $\V_{p,t}$ is a diagonal weight matrix.
